...
SECRET_KEY = 'zkjhv6)t^pwry27&_lm*z$688pjc$&zeik_n*vst#4yl91az)s'
...
REST_FRAMEWORK = {
    'DEFAULT_FILTER_BACKENDS': [
        ...
        'rest_framework.filters.OrderingFilter',  # Enables ordering functionality
        'rest_framework.filters.SearchFilter',    # Enables search functionality
    ],
}
